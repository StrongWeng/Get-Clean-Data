...
## variable names. in order to extract exact variable names of 
## original dat, we change capital letters of names to lowercases.
...
## because new data set is to be aggregated by mean on each 
## subjects for each activity, we prefix "Mean." to denote it. 
...
## define the types of variable and sort by subjects and activity
## to form a more readable data set.
