...
ytest=read.table("./UCI HAR Dataset/test/Y_test.txt",sep=""
                 ,col.names="Activity")
## Extracts only the measurements on mean and standard 
...
## Merge the separate data into one test set.
